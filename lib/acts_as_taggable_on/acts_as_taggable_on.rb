      ...
      module SingletonMethods
        ...
        def find_options_for_find_tagged_with(tags, options = {})
          ...
          if options.delete(:exclude)
            tags_conditions = tags.map { |t| sanitize_sql(["upper(#{Tag.table_name}.name) LIKE ?", t.upcase]) }.join(" OR ")
            ...
            conditions << tags.map { |t| sanitize_sql(["upper(#{tags_alias}.name) LIKE ?", t.upcase]) }.join(" OR ")
